...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo journey export --journey-id j02 --sort --no-metadata --no-deps --use-string-arrays -D journeyTestDirectory1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo journey export -SNa --no-deps --use-string-arrays --directory journeyTestDirectory2
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo journey export -SNAD journeyTestDirectory3
*/
...
describe('frodo journey export', () => {
    ...
    test('"frodo journey export --journey-id j02 --sort --no-metadata --no-deps --use-string-arrays -D journeyTestDirectory1": should export the journey with journey id "j02" to the folder named "journeyTestDirectory1", and the export should not contain dependencies and should use string arrays.', async () => {
        const exportFile = "j02.journey.json";
        const exportDirectory = "journeyTestDirectory1";
        const CMD = `frodo journey export --journey-id j02 --sort --no-metadata --no-deps --use-string-arrays -D ${exportDirectory}`;
    ...
    test('"frodo journey export -SNa --no-deps --use-string-arrays --directory journeyTestDirectory2": should export all journeys to a single file in the folder named "journeyTestDirectory2" with no dependencies and only string arrays in the export.', async () => {
        const exportFile = "allAlphaJourneys.journey.json";
        const exportDirectory = "journeyTestDirectory2";
        const CMD = `frodo journey export -SNa --no-deps --use-string-arrays --directory ${exportDirectory}`;
        await testExport(CMD, env, type, exportFile, exportDirectory, false);
    });
    ...
    test('"frodo journey export -SNAD journeyTestDirectory3": should export all journeys to separate files in the folder named "journeyTestDirectory3"', async () => {
        const exportDirectory = "journeyTestDirectory3";
        const CMD = `frodo journey export -SNAD ${exportDirectory}`;
