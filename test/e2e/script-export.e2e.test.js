...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo script export -SNn 'GitHub Profile Normalization' -D scriptExportTestDir1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo script export -SNaD scriptExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo script export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo script export -SNAxD scriptExportTestDir3
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo script export --all-separate --sort --no-metadata --extract --directory scriptExportTestDir4
*/
...
describe('frodo script export', () => {
  ...
  test('"frodo script export -SNn \'GitHub Profile Normalization\' -D scriptExportTestDir1": should export the script named "GitHub Profile Normalization" into the directory scriptExportTestDir1', async () => {
    const exportDirectory = 'scriptExportTestDir1';
    const CMD = `frodo script export -SNn 'GitHub Profile Normalization' -D ${exportDirectory}`;
  ...
  test('"frodo script export -SNaD scriptExportTestDir2": should export all scripts to a single file in the directory scriptExportTestDir2', async () => {
    const exportDirectory = 'scriptExportTestDir2';
    const CMD = `frodo script export -SNaD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo script export -SNAxD scriptExportTestDir3": should export all extracted scripts to separate files in the directory scriptExportTestDir3', async () => {
    const exportDirectory = 'scriptExportTestDir3';
    const CMD = `frodo script export -SNAxD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });

  test('"frodo script export --all-separate --sort --no-metadata --extract --directory scriptExportTestDir4": should export all extracted scripts to separate files in the directory scriptExportTestDir4', async () => {
    const exportDirectory = 'scriptExportTestDir4';
    const CMD = `frodo script export --all-separate --sort --no-metadata --extract --directory ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
});
