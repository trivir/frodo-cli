...
describe('frodo idm schema object export', () => {
  ...
  test('"frodo idm schema object export -AxD testDir7": should export managed object into separate files and extracted scripts in the directory "testDir7"', async () => {
