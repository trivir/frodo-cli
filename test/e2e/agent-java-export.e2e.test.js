...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent java export -SNi frodo-test-java-agent -D agentJavaExportTestDir1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent java export -SNaD agentJavaExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent java export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent java export --all-separate --sort --no-metadata --directory agentJavaExportTestDir3
*/
...
describe('frodo agent java export', () => {
    ...
    test('"frodo agent java export -SNi frodo-test-java-agent -D agentJavaExportTestDir1": should export the java agent with agent id "frodo-test-java-agent" into the directory agentJavaExportTestDir1', async () => {
        const exportDirectory = "agentJavaExportTestDir1";
        const CMD = `frodo agent java export -SNi frodo-test-java-agent -D ${exportDirectory}`;
    ...
    test('"frodo agent java export -SNaD agentJavaExportTestDir2": should export all java agents to a single file in the directory agentJavaExportTestDir2', async () => {
        const exportDirectory = "agentJavaExportTestDir2";
        const CMD = `frodo agent java export -SNaD ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
    ...
    test('"frodo agent java export --all-separate --sort --no-metadata --directory agentJavaExportTestDir3": should export all java agents to separate files in the directory agentJavaExportTestDir3', async () => {
        const exportDirectory = "agentJavaExportTestDir3";
        const CMD = `frodo agent java export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
});
