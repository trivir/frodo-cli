...
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager pull org-privileges -D configManagerExportOrgPrivilegesDir1 -n alphaOrgPrivileges
*/
...
describe('frodo config-manager pull org-privileges', () => {
    ...
    test('"frodo config-manager pull org-privileges -D configManagerExportOrgPrivilegesDir1 -n alphaOrgPrivileges": should export the alpha realm organization privileges in fr-config manager style.', async () => {
