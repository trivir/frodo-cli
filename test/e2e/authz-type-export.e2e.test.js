...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export --type-name URL -f my-URL.resourcetype.authz.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export -SNn URL -D authzTypeExportTestDir1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export -i 76656a38-5f8e-401b-83aa-4ccb74ce88d2 -f my-76656a38-5f8e-401b-83aa-4ccb74ce88d2.resourcetype.authz.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export -SNi 76656a38-5f8e-401b-83aa-4ccb74ce88d2 -D authzTypeExportTestDir2
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export -SNaD authzTypeExportTestDir3
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo authz type export --all-separate --sort --no-metadata --directory authzTypeExportTestDir4
*/
...
describe('frodo authz type export', () => {
  ...
  test('"frodo authz type export -SNn URL -D authzTypeExportTestDir1": should export the resource type named "URL" to the directory authzTypeExportTestDir1', async () => {
    const exportDirectory = 'authzTypeExportTestDir1';
    const CMD = `frodo authz type export -SNn URL -D ${exportDirectory}`;
  ...
  test('"frodo authz type export -SNi 76656a38-5f8e-401b-83aa-4ccb74ce88d2 -D authzTypeExportTestDir2": should export the resource type with id "76656a38-5f8e-401b-83aa-4ccb74ce88d2" into the directory authzTypeExportTestDir2', async () => {
    const exportDirectory = 'authzTypeExportTestDir2';
    const CMD = `frodo authz type export -SNi 76656a38-5f8e-401b-83aa-4ccb74ce88d2 -D ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo authz type export -SNaD authzTypeExportTestDir3": should export all resource types to a single file in the directory authzTypeExportTestDir3', async () => {
    const exportDirectory = 'authzTypeExportTestDir3';
    const CMD = `frodo authz type export -SNaD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo authz type export --all-separate --sort --no-metadata --directory authzTypeExportTestDir4": should export all resource types to separate files in the directory authzTypeExportTestDir4', async () => {
    const exportDirectory = "authzTypeExportTestDir4";
    const CMD = `frodo authz type export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
});
