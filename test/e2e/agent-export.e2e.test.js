...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export -i frodo-test-web-agent -f my-frodo-test-web-agent.agent.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export -SNi frodo-test-web-agent -D agentExportTestDir1
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export --all
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export -a --file my-allAlphaAgents.agent.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export -SNaD agentExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo agent export --all-separate --sort --no-metadata --directory agentExportTestDir3
*/
...
describe('frodo agent export', () => {
    ...
    test('"frodo agent export -SNi frodo-test-web-agent -D agentExportTestDir1": should export the agent with agent id "frodo-test-web-agent" into the directory named agentExportTestDir1', async () => {
        const exportDirectory = "agentExportTestDir1";
        const CMD = `frodo agent export -SNi frodo-test-web-agent -D ${exportDirectory}`;
    ...
    test('"frodo agent export -SNaD agentExportTestDir2": should export all agents to a single file in the directory agentExportTestDir2', async () => {
        const exportDirectory = "agentExportTestDir2";
        const CMD = `frodo agent export -SNaD ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
    ...
    test('"frodo agent export --all-separate --sort --no-metadata --directory agentExportTestDir3": should export all agents to separate files in the directory agentExportTestDir3', async () => {
        const exportDirectory = "agentExportTestDir3";
        const CMD = `frodo agent export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
});
