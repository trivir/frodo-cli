...
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_REALM=alpha FRODO_HOST=https://nightly.gcp.forgeops.com/am frodo config-manager pull scripts -D configManagerExportScriptsDir2 --prefix OAUTH2 --prefix SAML -m forgeops (alpha realm)
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_REALM=bravo FRODO_HOST=https://nightly.gcp.forgeops.com/am frodo config-manager pull scripts -D configManagerExportScriptsDir3 -n 'Library Script' -m forgeops (bravo realm)
