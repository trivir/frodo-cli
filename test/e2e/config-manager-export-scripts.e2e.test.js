...
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir7 -r bravo -p SAML2 --just-config
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir8 -r bravo --just-content
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir9 -r bravo -p SAML2 --just-config --script-type SAML2_NAMEID_MAPPER
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir10 --just-config
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir11 -r bravo --just-config
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir12 -r bravo -p SAML2 --just-content
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir13 --just-config --just-content
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir14 --script-type LIBRARY
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir15 -r bravo --script-type LIBRARY
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir16 -n 'Coin Flip'
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir17 -r bravo -p SAML2 --script-type SAML2_NAMEID_MAPPER
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager export scripts -D configManagerExportScriptsDir18 -r bravo -p SAML2
...
describe('frodo config-manager export scripts', () => {
    test(`"frodo config-manager export scripts -D configManagerExportScriptsDir0": should export all scripts from all realms in fr-config manager style.`, async () => {
        const dirName = 'configManagerExportScriptsDir0';
        const CMD = `frodo config-manager export scripts -D ${dirName}`;
        await testExport(CMD, env, undefined, undefined, dirName, false);
    });
    test(`"frodo config-manager export scripts -D configManagerExportScriptsDir1 -p OAuth2": should export all scripts from all realms that start with OAuth2 in fr-config manager style.`, async () => {
        const dirName = 'configManagerExportScriptsDir1';
        const prefix = 'OAuth2'
        const CMD = `frodo config-manager export scripts -D ${dirName} -p ${prefix}`;
        await testExport(CMD, env, undefined, undefined, dirName, false);
    });
    test(`"frodo config-manager export scripts -D configManagerExportScriptsDir2 -r bravo": should export all scripts from the bravo realm in fr-config manager style.`, async () => {
        const dirName = 'configManagerExportScriptsDir2';
        const realm = 'bravo';
        const CMD = `frodo config-manager export scripts -D ${dirName} -r ${realm}`;
        await testExport(CMD, env, undefined, undefined, dirName, false);
    });
    test(`"frodo config-manager export scripts -D configManagerExportScriptsDir3 -n 'Bravo OIDC Claims Script' -r bravo": should export only the script with the name: "Bravo OIDC Claims Script".`, async () => {
        const dirName = 'configManagerExportScriptsDir3';
        const scriptName = 'Bravo OIDC Claims Script';
        const realm = 'bravo';
        const CMD = `frodo config-manager export scripts -D ${dirName} -n '${scriptName}' -r ${realm}`;
        await testExport(CMD, env, undefined, undefined, dirName, false);
    });
    test(`"frodo config-manager export scripts -D configManagerExportScriptsDir4 -r bravo -p OAuth2 --just-config --script-type OAUTH2_MAY_ACT --just-content --language GROOVY": should export just the script content in the bravo realm that start with OAuth2 that are of the type OAuth2 May Act and are in the programming language of groovy".`, async () => {
