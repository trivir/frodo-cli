...
FRODO_MOCK=record FRODO_NO_CACHE=1 FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo config-manager pull scripts -D configManagerExportScriptsDir4 -r bravo -p OAuth2 --script-type OAUTH2_MAY_ACT --just-content --language GROOVY
