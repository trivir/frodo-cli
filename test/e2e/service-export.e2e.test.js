...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export --service-id policyconfiguration -f my-policyconfiguration.service.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -SNi policyconfiguration -D serviceExportTestDir1
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -gi dashboard
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export --global --service-id dashboard -f my-dashboard.service.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -SNgi dashboard -D serviceExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -a
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export --all --file my-allAlphaServices.service.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -ga
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export --global --all -f my-allGlobalServices.service.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -SNaD serviceExportTestDir3
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -g --all-separate
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo service export -A --sort --no-metadata --directory serviceExportTestDir4
*/
...
describe('frodo service export', () => {
  ...
  test('"frodo service export -SNi policyconfiguration -D serviceExportTestDir1": should export the service with id "policyconfiguration" to the directory serviceExportTestDir1', async () => {
    const exportDirectory = 'serviceExportTestDir1';
    const CMD = `frodo service export -SNi policyconfiguration -D ${exportDirectory}`;
  ...
  test('"frodo service export -SNgi dashboard -D serviceExportTestDir2": should export the global service with id "dashboard" to the directory serviceExportTestDir2', async () => {
    const exportDirectory = 'serviceExportTestDir2';
    const CMD = `frodo service export -SNgi dashboard -D ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo service export -SNaD serviceExportTestDir3": should export all services to a single file in the directory serviceExportTestDir3', async () => {
    const exportDirectory = 'serviceExportTestDir3';
    const CMD = `frodo service export -SNaD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo service export -A --sort --no-metadata --directory serviceExportTestDir4": should export all services to separate files in the directory serviceExportTestDir4', async () => {
    const exportDirectory = "serviceExportTestDir4";
    const CMD = `frodo service export -A --sort --no-metadata --directory ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
