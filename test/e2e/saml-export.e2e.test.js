...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml export -SNi iSPAzure -D samlExportTestDir1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml export -SNaD samlExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml export --all-separate --sort --no-metadata --directory samlExportTestDir3
*/
...
describe('frodo saml export', () => {
  ...
  test('"frodo saml export -SNi iSPAzure -D samlExportTestDir1": should export the saml provider with entity id "iSPAzure" into the directory samlExportTestDir1', async () => {
    const exportDirectory = 'samlExportTestDir1';
    const CMD = `frodo saml export -SNi iSPAzure -D ${exportDirectory}`;
  ...
  test('"frodo saml export -SNaD samlExportTestDir2": should export all saml providers to a single file in the directory samlExportTestDir2', async () => {
    const exportDirectory = 'samlExportTestDir2';
    const CMD = `frodo saml export -SNaD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo saml export --all-separate --sort --no-metadata --directory samlExportTestDir3": should export all saml providers to separate files in the directory samlExportTestDir3', async () => {
    const exportDirectory = 'samlExportTestDir3';
    const CMD = `frodo saml export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
});
