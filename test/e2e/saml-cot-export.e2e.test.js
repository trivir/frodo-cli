...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export -i AzureCOT -f my-AzureCOT.cot.saml.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export -SNi AzureCOT -D samlCotExportTestDir1
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export --all
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export -a --file my-allAlphaCirclesOfTrust.cot.saml.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export -SNaD samlCotExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo saml cot export --all-separate --sort --no-metadata --directory samlCotExportTestDir3
*/
...
describe('frodo saml cot export', () => {
    ...
    test('"frodo saml cot export -SNi AzureCOT -D samlCotExportTestDir1": should export the saml circles of trust with id "AzureCOT" into the directory named samlCotExportTestDir1', async () => {
        const exportDirectory = "samlCotExportTestDir1";
        const CMD = `frodo saml cot export -SNi AzureCOT -D ${exportDirectory}`;
    ...
    test('"frodo saml cot export -SNaD samlCotExportTestDir2": should export all saml circles of trust to a single file in the directory samlCotExportTestDir2', async () => {
        const exportDirectory = "samlCotExportTestDir2";
        const CMD = `frodo saml cot export -SNaD ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
    ...
    test('"frodo saml cot export --all-separate --sort --no-metadata --directory samlCotExportTestDir3": should export all saml circles of trust to separate files in the directory samlCotExportTestDir3', async () => {
        const exportDirectory = "samlCotExportTestDir3";
        const CMD = `frodo saml cot export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
        await testExport(CMD, env, type, undefined, exportDirectory, false);
    });
});
