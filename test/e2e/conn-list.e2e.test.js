...
describe('frodo conn list', () => {
  testif(process.env['FRODO_MASTER_KEY'] || process.env['FRODO_MASTER_KEY_PATH'])(
    '"frodo conn list": should list the connection profile names',
    async () => {
  ...
  testif(process.env['FRODO_MASTER_KEY'] || process.env['FRODO_MASTER_KEY_PATH'])(
    '"frodo conn list -l": should list the connection names, hosts, service accounts, usernames, and log API keys.',
    async () => {
  ...
  testif(process.env['FRODO_MASTER_KEY'] || process.env['FRODO_MASTER_KEY_PATH'])(
    '"frodo conn list --long": should list the connection names, hosts, service accounts, usernames, and log API keys.',
    async () => {
