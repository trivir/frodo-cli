...
/*
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export --template-id welcome
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export -i welcome -f my-welcome.template.email.json
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export -SNi welcome -D emailTemplateExportTestDir1
...
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export -SNaD emailTemplateExportTestDir2
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export -A
FRODO_MOCK=record FRODO_HOST=https://openam-frodo-dev.forgeblocks.com/am frodo email template export --all-separate --sort --no-metadata --directory emailTemplateExportTestDir3
*/
...
describe('frodo email template export', () => {
  ...
  test('"frodo email template export -SNi welcome -D emailTemplateExportTestDir1": should export the email template with email id "welcome" into the directory emailTemplateExportTestDir1', async () => {
    const exportDirectory = 'emailTemplateExportTestDir1';
    const CMD = `frodo email template export -SNi welcome -D ${exportDirectory}`;
  ...
  test('"frodo email template export -SNaD emailTemplateExportTestDir2": should export all email templates to a single file in the directory emailTemplateExportTestDir2', async () => {
    const exportDirectory = 'emailTemplateExportTestDir2';
    const CMD = `frodo email template export -SNaD ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
  ...
  test('"frodo email template export --all-separate --sort --no-metadata --directory emailTemplateExportTestDir3": should export all email templates to separate files in the directory emailTemplateExportTestDir3', async () => {
    const exportDirectory = 'emailTemplateExportTestDir3';
    const CMD = `frodo email template export --all-separate --sort --no-metadata --directory ${exportDirectory}`;
    await testExport(CMD, env, type, undefined, exportDirectory, false);
  });
});
