...
describe('frodo script import', () => {
    ...
    test(`"frodo script import -FAD ${allForgeopsFootSeparateScriptsDirectory} -m forgeops": should import all scripts from the ${allForgeopsFootSeparateScriptsDirectory} directory`, async () => {
        const CMD = `frodo script import -FAD ${allForgeopsFootSeparateScriptsDirectory} -m forgeops`;
        await testSuccess(CMD, env);
    });

    test(`"frodo script import --default --no-deps --all-separate --directory ${allForgeopsFootSeparateScriptsDirectory} -m forgeops": should not import all unchanged scripts, including defaults, from the ${allForgeopsFootSeparateScriptsDirectory} directory`, async () => {
