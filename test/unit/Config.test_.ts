// Disabled: references Config.isIdUsed, which no longer exists on the
// current Config module (this .ts file was never actually picked up by
...
describe('Config - isIdUsed()', () => {
  const exportObject = {
    ...
    script: {
      'a271c7e6-5d49-4866-a1ab-5e0ee770a8c5': {
        ...
        script: ['This', 'is', 'a', 'very &{esv.test.variable} cool', 'test'],
        createdBy: 'user',
  ...
  test('isIdUsed() 1: Correctly determines that ids are or are not being used', async () => {
    ...
    expect(
      Config.isIdUsed(exportObject, 'esv-test-variable', true)
    ).toStrictEqual({
      used: true,
      location:
        "script.a271c7e6-5d49-4866-a1ab-5e0ee770a8c5(name: 'script1').script.3",
    });
    ...
    expect(
      ...
      used: true,
      location:
        "script.a271c7e6-5d49-4866-a1ab-5e0ee770a8c5(name: 'script1')._id",
    });
    expect(
      Config.isIdUsed(
        exportObject,
      ...
      used: true,
      location:
        "script.8a1b71c6-51d4-42d7-85dd-dcc2a9553b1c(name: 'script2')._id",
    });
    expect(
      Config.isIdUsed(
        exportObject,
      ...
      used: true,
      location:
        "script.b8005c1c-e5a6-4718-878f-3c667142aa67(name: 'script3')._id",
    });
  });
});
