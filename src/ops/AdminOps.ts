...
export async function generateRfc7523AuthZGrantArtefacts(
  ...
  try {
    ...
    if (json) {
      ...
      client.push([c.cyan('Client ID'), clientId]);
      client.push([c.cyan('Client Name'), clientId]);
      client.push([
        c.cyan('Scopes'),
        (
      ...
      client.push([
        c.cyan('Token Endpoint Authentication '),
        (
          artefacts.client.advancedOAuth2ClientConfig
      ...
      issuer.push([c.cyan('Name'), artefacts.issuer._id]);
      issuer.push([
        c.cyan('JWT Issuer'),
        (artefacts.issuer.issuer as Writable<string>).value,
      ]);
      issuer.push([
        c.cyan('Allowed Subjects              '),
