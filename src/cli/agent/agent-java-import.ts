    ...
    .action(
      ...
      async (host, realm, user, password, options, command) => {
        ...
        if (options.agentId) {
          ...
          outcome = await importJavaAgentFromFile(
            options.agentId,
            options.file
          );
        }
