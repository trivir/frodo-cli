...
export default function setup() {
  ...
  program
    ...
    .addOption(
      new Option(
        '-a, --all',
        'Export all web agents to a single file. Cannot be used with -i or -A.'
      ).conflicts(['agentId', 'allSeparate'])
    )
    .addOption(
      new Option(
        '-A, --all-separate',
        'Export all web agents to separate files (*.webagent.json) in the current directory. Cannot be used with -i or -a.'
