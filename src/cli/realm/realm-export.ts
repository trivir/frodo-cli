...
export default function setup() {
  ...
  program
    ...
    .addOption(
      new Option(
        '-i, --realm-id <realm-id>',
        'Realm id. If specified, -a and -A are ignored.'
      )
    )
    .addOption(
      new Option(
    ...
    .addOption(
      new Option(
        '-a, --all',
        'Export all realms to a single file. Ignored with -i.'
      )
    )
    .addOption(
      new Option(
        '-A, --all-separate',
        'Export all realms to separate files (*.realm.json) in the current directory. Ignored with -i or -a.'
      )
    )
    .addOption(
      new Option(
