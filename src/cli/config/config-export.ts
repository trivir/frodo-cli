...
export default function setup() {
  ...
  program
    ...
    .addHelpText(
      'after',
      c.green(`How Frodo handles secrets:\n`) +
        c.green(
        ...
        c.cyan(`  $ frodo config export -sxAND . ${s.connId}\n`) +
        ...
        c.cyan(`  $ frodo config export -adR ${s.connId}\n`) +
        `  Export only the bravo realm configuration:\n` +
        c.cyan(`  $ frodo config export -ar ${s.connId} bravo\n`) +
